    ...
    this.state.web3.eth.getAccounts((error, accounts) => {
      ...
      myBounty.deployed().then((instance) => {
       ...
       /// this.setState({ web3.eth.defaultAccount: this.state.web3.eth.accounts[0] })
        ...
        //var bcount = myBountyInstance.methods.bountyCount().call(function(err, res){
        //  console.log(res) 
        //  return res 
        //})
        ...
        //return this.setState({ myBountyInstance: myBountyInstance })
        //return myBountyInstance.methods.bountyCount().call
      ...
      //     bountBoard.push(myBountyInstance.fetchBounty(i))
      //     console.log(myBountyInstance.fetchBounty(i))
      //   }
      //   return this.setState({ testList: this.bountBoard })
      // })
    ...
    return (
      <div className="App">
        ...
        <main className="container">
            ...
            <hr />
            bounty inst  <Stringify value={this.state.z} />
